...
# upstream   https://github.com/tomfrenzel/ProxmoxVED.git (fetch)
# upstream   https://github.com/tomfrenzel/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/tomfrenzel/ProxmoxVED"
echo ""
